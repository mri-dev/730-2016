...
$config = array(
    ...
    'BACK_REF' 			=> 'http://'.$_SERVER['HTTP_HOST'].'/simple/back',	//url of payu payment backref page
    'TIMEOUT_URL' 		=> 'http://'.$_SERVER['HTTP_HOST'].'/simple/timeout',	//url of payu payment timeout page
    'IRN_BACK_URL' 		=> 'http://'.$_SERVER['HTTP_HOST'].'/simple/irn',		//url of payu payment irn page
    'IDN_BACK_URL' 		=> 'http://'.$_SERVER['HTTP_HOST'].'/simple/idn',		//url of payu payment idn page
    'CURL' => true,
    'ORDER_TIMEOUT' => 300,
    'LANGUAGE' => 'HU',
    'GET_DATA' => $_GET,
